...
private:
	...
	QAction *actInsertChars, *actInsertDate, *actInsertTime;
	...
	QMenu *menuFile, *menuTools, *menuView, *menuHelp, *menuFormatting, *menuInsert;
...
private slots:
	...
	void onReadOnly();
	void onInsertChar();
	void onInsertDate(bool isDate = true);
	void onAbout();
	void onAboutQt();
	void onShowHelp();
};
